...
samples <- read.csv('/Users/LoboM/Dropbox/chip_bams/H3K27me3/samplesheet_2.csv')
...
# dev.off()
savedir = '/Users/LoboM/Dropbox/sharedUMass_Macrina_Rene/hESC_2021/bulk/ChIP/downstream_H3K27me3/'
...
# save TMM quan norm counts in H3K27me3 regions 
...
# rerun beginning to make peaks file
...
write.table(tmp1, file = file.path(savedir,"consensus_atac_H3K27me3_counts_tmm_quan_norm.csv"), sep = "\t",
            row.names = TRUE, col.names = TRUE, quote=FALSE)
write.table(matrix_counts_tmm, file = file.path(savedir,"consensus_atac_H3K27me3_counts_tmm.csv"), sep = "\t",
            row.names = TRUE, col.names = TRUE, quote=FALSE)
